...
export const mockStrategies: StrategyDisplay[] = [
  {
    ...
    protocol: 'KLend2g3cP87fffoy8q1mQqGKjrL823wfeB2iBygTsOW',
    feeBps: 1000,
    totalDeposits: 45_000_000_000n,
    currentNav: 45_200_000_000n,
    totalShares: 44_800_000_000n,
    totalInvestors: 23,
    highWaterMark: 1_008_900_000n,
  ...
  },
  {
    ...
    protocol: 'MarBmsSgKXdrN1egZf5sqe1TMai9K1rChYNDJgjq7aD',
    feeBps: 500,
    totalDeposits: 120_000_000_000_000n,
    currentNav: 120_400_000_000_000n,
    totalShares: 119_800_000_000_000n,
    totalInvestors: 54,
    highWaterMark: 1_005_000_000n,
    minDeposit: 1_000_000n,
    status: 'active' as const,
    sharePrice: 1.005,
...
export const mockMarkets: MarketDisplay[] = [
  {
    ...
    authority: '9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM',
    subsidyProvider: '9WzDXwBbmkg8ZTbNMqUxvQRAyrZzDsGYdLVL9zYtAWWM',
    question: 'Will USDC Compounder exceed 15% APY by Apr 30?',
    marketType: 'absolute' as const,
    marketId: 1,
    thresholdBps: 1500,
    resolutionSlot: 312_000_000,
    yesShares: 3_800_000_000n,
    noShares: 6_200_000_000n,
    totalYesCost: 3_800_000_000n,
    totalNoCost: 6_200_000_000n,
  ...
  },
  {
    ...
    authority: 'AgA1phKjMRiX5cpLxP2FUzHsRqMqqFzpTQ2GhwdKgnEP',
    subsidyProvider: 'AgA1phKjMRiX5cpLxP2FUzHsRqMqqFzpTQ2GhwdKgnEP',
    ...
    totalYesCost: 4_300_000_000n,
    totalNoCost: 5_700_000_000n,
    liquidityParam: 1_000_000_000n,
  ...
  },
  {
    ...
    authority: 'ALiC3Nba6wiu5AUQKZ6JLiApR9mFKRim43xDQPNhKyfe',
    subsidyProvider: 'ALiC3Nba6wiu5AUQKZ6JLiApR9mFKRim43xDQPNhKyfe',
    question: 'Will SOL Staking Plus outperform Delta Neutral this week?',
    marketType: 'relative' as const,
    marketId: 1,
    thresholdBps: 0,
    resolutionSlot: 310_500_000,
    yesShares: 5_500_000_000n,
    noShares: 4_500_000_000n,
    totalYesCost: 5_500_000_000n,
    totalNoCost: 4_500_000_000n,
    liquidityParam: 1_000_000_000n,
  ...
  },
  {
    ...
    totalYesCost: 7_200_000_000n,
    totalNoCost: 2_800_000_000n,
    liquidityParam: 1_000_000_000n,
